...
public class WebChatHandler implements HttpHandler {
    ...
    private String buildChatPage(User user, String token) {
        ...
        h.append("<div class='chat-msg system welcome'><strong>WELCOME, ").append(HtmlTemplates.escapeHtml(user.getUsername()).toUpperCase()).append("</strong><br>");
        ...
        h.append("<span class='quick-chip chip-sale' onclick=\"insertTag('[sale] ')\"><i class='ti ti-plus'></i> SALE</span>");
        h.append("<span class='quick-chip chip-expense' onclick=\"insertTag('[expense] ')\"><i class='ti ti-minus'></i> EXPENSE</span>");
        h.append("<span class='quick-chip chip-debt' onclick=\"insertTag('[debt] ')\"><i class='ti ti-scale'></i> DEBT</span>");
        h.append("<span class='quick-chip chip-payment' onclick=\"insertTag('[payment] ')\"><i class='ti ti-cash'></i> PAYMENT</span>");
        h.append("<span class='quick-chip chip-profit' onclick=\"insertText('what is my profit')\"><i class='ti ti-chart-bar'></i> PROFIT</span>");
        h.append("<span class='quick-chip chip-debtors' onclick=\"insertText('who owes me')\"><i class='ti ti-users'></i> DEBTORS</span>");
        h.append("</div>");
