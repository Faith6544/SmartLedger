...
public class LandingHandler implements HttpHandler {
    ...
    private String buildLanding() {
        return "<!DOCTYPE html><html><head><meta charset='UTF-8'>" +
                ...
                // Navbar
                "<div class='navbar'>" +
                "<div style='display:flex;align-items:center;gap:8px;'><div style='width:32px;height:32px;background:#1a1a2e;border-radius:50%;display:flex;align-items:center;justify-content:center;'><img src='"
                + HtmlTemplates.LOGO_DATA + "' style='width:20px;height:20px;'></div><h1>SmartLedger</h1></div>" +
                "<div>" +
